...
func _ready():
	...
	randomize()
	# A: populate board
	CmnFunc.fill_grid(hbox_container, grid_container, "res://game_boards/board_space/board/board_square_0.tscn", "res://game_boards/board_space/board/board_square_1.tscn")
