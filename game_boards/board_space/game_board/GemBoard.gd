...
var selected_cell_2:GemCellSpace = null
var undo_cell_1:GemCellSpace = null
var undo_cell_2:GemCellSpace = null
...
func find_gem_indices(gem_cell:GemCellSpace) -> Dictionary:
	...
	# Get the index of the GemCellSpace in the VBoxContainer
...
func are_cells_adjacent(gemcell1:GemCellSpace, gemcell2:GemCellSpace) -> bool:
...
func get_all_matches() -> Array:
	...
	for row in range(num_rows):
		...
		for column in range(num_columns):
			var gem_cell = hbox_container.get_child(column).get_child(row) as GemCellSpace
...
func _on_cell_click(gem_cell:GemCellSpace):
	...
	# STEP 1: Select GemCellSpace logic
...
func swap_gem_cells(swap_cell_1:GemCellSpace, swap_cell_2:GemCellSpace):
...
func setup_tween(gem_cell:GemCellSpace, start_pos:Vector2, end_pos:Vector2):
...
func debug_print_column_ascii(column: VBoxContainer, column_index: int):
	...
	for i in range(column.get_child_count() - 1, -1, -1):  # Print from top to bottom
		var gem_cell = column.get_child(i) as GemCellSpace
		if gem_cell != null:
...
func debug_make_match_col():
	...
	var col0_child4:GemCellSpace = col0.get_child(4)
	col0_child4.initialize(Enums.GemColor.GREEN)
	var col0_child5:GemCellSpace = col0.get_child(5)
	col0_child5.initialize(Enums.GemColor.GREEN)
	var col0_child6:GemCellSpace = col0.get_child(6)
	col0_child6.initialize(Enums.GemColor.GREEN)
	var col0_child7:GemCellSpace = col0.get_child(7)
